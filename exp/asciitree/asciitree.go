...
func (br Branchs) Modify(hideVertTop bool, attachLabelLength int, attachDescriptionLength int, horizLength int, childBranchOffset int) Branchs {
	...
	if hideVertTop {
		...
		l := runesstr.Length(br.AttachLabel)
		if l > 0 {
			br.AttachLabelRepl = runesstr.Left(br.AttachLabelRepl, l-1)
		}
	}
...
func (br Branchs) Build(root *tree.Node, renderer func(*tree.Node) ([]string, []string)) (result multistrings.MultiStrings) {
...
func Build(root *tree.Node, br Branchs, renderer func(*tree.Node) ([]string, []string)) (result multistrings.MultiStrings) {
	prcssStr := func(n *tree.Node, s string) {
		result = append(result, s)
	}
	build(root, br, 0, "", false, renderer, prcssStr)
...
func build(n *tree.Node, br Branchs, deep int, indent string, isLastChild bool, renderer func(*tree.Node) ([]string, []string), processString func(*tree.Node, string)) (result multistrings.MultiStrings) {
	var s string
